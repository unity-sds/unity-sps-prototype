...
| <a name="input_eks_node_groups"></a> [eks\_node\_groups](#input\_eks\_node\_groups) | value | `string` | n/a | yes |
...
| <a name="input_subnets"></a> [subnets](#input\_subnets) | value | `string` | n/a | yes |
